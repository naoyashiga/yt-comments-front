  ...
  return (
    <footer className="bg-white pt-4 pb-8 dark:bg-gray-800 xl:pt-8">
      <div className="mx-auto max-w-screen-lg px-4 text-gray-400 dark:text-gray-300 sm:px-6 md:px-8 xl:max-w-screen-xl">
        ...
        <div className="mx-auto flex max-w-xs items-center justify-between border-t border-gray-200 pt-8">
          <Link href="#">
            <svg
              width="20"
              height="20"
        ...
        <div className="flex items-center justify-center pt-10 text-center font-light sm:pt-12">
          Created by Charlie
        </div>
      </div>
    </footer>
